...
const useStyles = makeStyles(() =>
  createStyles({
    ...
    left: {
        ...
        padding:"1.5rem",
        cursor: 'pointer',
        border:(style: Props & Theme) => style.isLeft ?  `1px solid ${style.backgroundWhite}`: `1px solid ${style.backgroundLight3}` ,
    ...
    right: {
        ...
        padding:"1.5rem",
        cursor: 'pointer',
        border:(style: Props & Theme) => style.isLeft ?  `1px solid ${style.backgroundLight3}` : `1px solid ${style.backgroundWhite}`,
