...
const MainSideBar: FC<MainSideBarProps> = ({
  ...
  return (
    <div
      className={`${classes.sideBar} flex flex-row overflow-x-auto sm:flex-col sm:justify-start sm:items-center w-full sm:h-full bg-color-shade-dark-3-day dark:bg-color-shade-dark-3-night`}
    >
      {items.map((item) => {
        return (
          <MainSideBarItem
