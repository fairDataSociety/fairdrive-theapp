...
const DriveCardIcon: FC<DriveCardIconProps> = ({ type, fileExtention }) => {
  return (
    <div className="">
      ...
      {type === 'file' ? (
        <span className="block -mt-10 mb-5 lg:mb-10 ml-0 lg:ml-3 text-center lg:text-center text-color-shade-black-day dark:text-color-accents-grey-pastel uppercase z-20">
          {fileExtention}
        </span>
      ) : null}
    </div>
